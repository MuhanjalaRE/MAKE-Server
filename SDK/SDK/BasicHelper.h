...
class FUObjectItem {
   public:
    ...
    unsigned char pad_3T8LDDME3K[0x04];
    enum class ObjectFlags : int32_t { None = 0, Native = 1 << 25, Async = 1 << 26, AsyncLoading = 1 << 27, Unreachable = 1 << 28, PendingKill = 1 << 29, RootSet = 1 << 30, NoStrongReference = 1 << 31 };
...
class FStructBaseChain {
    ...
    unsigned char pad_X43KASX2FM[0x04];
};
